        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="SP_Confirm_order.php">Pending Orders</a></li>            
              
              <li><a href="SP_pending_order.php">Confirmed Orders</a></li>
              <li><a href="edit_sp.php">Edit profile</a></li>
   ...
   <br> 
    ...
    <div class="successmsg">Password has been changed...</div>
      <?php } ?>
            ...
            <p>Welcome! <strong style="font-size: larger; color: #33CC00"><?php echo $catering_name; ?></strong></p>
  </center>
           </div>
          ...
          <tr>
           ...
           <tr>
              ...
              <td><?php echo $price_per_plate; ?></td>
          </tr>
          </table>
           <div class="row">
            <div class="col-sm-2">
