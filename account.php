...
<html lang="en">
  <head>
    ...
    <title>Rialto Events and Rentals | Account Page</title>
  ...
  <section id="aa-catg-head-banner">
    <img src="login2.jpg" alt="fashion img" width="1500px" height="200px">
    <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        <h2>Rialto Events and Rentals</h2>
      </div>
     </div>
   </div>
  </section>
        ...
        <div class="aa-myaccount-area">         
            <div class="row">
              <div class="col-md-6">
                ...
                <h4>Login</h4>
                 <form action="userlogin.php" class="aa-login-form" method="post">
                  <label for="">Email<span>*</span></label>
                   <input name="email"  type="text" placeholder="Email address">
                   <label for="">Password<span>*</span></label>
                    <input name="password" type="password" placeholder="Password">
                    <button type='submit' name='lsubmit' class="aa-browse-btn">Login</button>
              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <form action="register.php" class="aa-login-form" method = "POST">
                    ...
                    <input name = "register_name" type="text" placeholder="Username">

                    <label for=""> Address<span>*</span></label>
                    <input name = "register_address" type="text" placeholder="Address">
